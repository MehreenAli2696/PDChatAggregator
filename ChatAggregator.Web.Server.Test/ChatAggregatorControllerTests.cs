...
using ChatAggregator.Web.Server.Controllers;
using Moq;

namespace ChatAggregator.Web.Server.Test
{
    public class ChatAggregatorControllerTests
    {
        ...
        {
            var expectedReport = new List<ChatEventResult>() { new() { Time = "Expected Key", EventReport = "Expected Value" } };
